...
insert into C##LDILDI.LDI_t1 values(35555,'asdv');
...
select ora_RowSCN, fr, sr from C##LDILDI.LDI_t1
where fr = 35555
;
...
SELECT BLOCK_SIZE FROM DBA_TABLESPACES WHERE TABLESPACE_NAME = 'LDI_QDATA';
